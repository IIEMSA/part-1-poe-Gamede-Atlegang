...
namespace EventEaseWebApp.Controllers
{
    public class EventsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("EventId,VenueId,EventName,EventDate,Description")] Events @event)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EventId,VenueId,EventName,EventDate,Description")] Events @event)
        {
            if (id != @event.EventId)
            {
                return NotFound();
